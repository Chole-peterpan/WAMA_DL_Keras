...
clc;
clear;
mat_path = 'H:\@data_NENs_recurrence\PNENs\data\2block';
...
workspaces = load(strcat(mat_savepath,filesep,'subject',filesep,'subject.mat'));
...
for ii = 1:length(filename_list)
    ...
    % 读取block
    data_path=strcat(mat_path,filesep,filename);
