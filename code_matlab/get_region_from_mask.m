function [tumor_mat,mask_mat,tumor_volum,or_size,location] = get_region_from_mask(data,mask,extend_pixel)
%抠出函数
...
d3_min = min(I3)-extend_pixel;
d3_max = max(I3)+extend_pixel;
