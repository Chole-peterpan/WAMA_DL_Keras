function [subject] = get_subject_from_filename(filename_list,data_path)
...
% 如果储存各个模态的cell长度大于1，那么就代表有多个模态，故置位contain_orthermode
contain_orthermode = length(data_path);
...
for i =1:length(subject_id_list)
    ...
    % 是否包含其他mode的flag，如果包含，则等于模态数量或序列数量
