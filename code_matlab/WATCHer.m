%% step1ï¿½ï¿½initialization

clear;
clc;
close all
% while(1)
%% step2ï¿½ï¿½set the log path and other parameter
...
minibatch_loss_path = strcat(log_path,filesep,'@1_loss.txt');
...
hold off;
%% step3ï¿½ï¿½ï¿½ï¿½È¡verifyï¿½ï¿½ï¿½ï¿½resultï¿½ï¿½ï¿???
if verify_flag
...
%% step4ï¿½ï¿½ï¿½ï¿½È¡testï¿½ï¿½ï¿½ï¿½resultï¿½ï¿½ï¿???
if test_flag
