...
def dual_path_net(initial_conv_filters, filter_increment, depth, cardinality, width, pooling='max-avg', bias_flag=False,classes=2):
    '''
    Args:
    ...
    out = Dense(classes, name='fc1',use_bias=bias_flag)(out_drop)
