...
batch_size = 6
max_iter = 200000
min_verify_Iters = 100000   # 开始验证的最小迭代次数:batch*diedaishu = epoch
...
Result_save_Path = r'/data/XS_Aug_model_result/model_templete/diploma_real/test25'#============================#!!!!!! 保存路径保存路径保存路径保存路径保存路径
