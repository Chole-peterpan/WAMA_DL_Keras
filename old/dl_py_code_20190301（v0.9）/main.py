...
min_verify_Iters = 30000   # 开始验证的最小迭代次数
verify_Iters_step = 40   # verify every 'verify_Iters_step' times
...
# 分折信息导入
aug_path = r'/data/@data_dasheng/aug'  # CD patient is positive
test_path = r'/data/@data_dasheng/test'
folder_path = r'/LAOAWNG/fenzhexinxi_dasheng'
Result_save_Path = r'/data/XS_Aug_model_result/model_templete/diploma/dashengfold1'
model_save_Path = r'/data/XS_Aug_model_result/model_templete/diploma/dashengfold1'
foldname = '1'
...
if __name__ == "__main__":
    ...
    for i in range(max_iter):
        ...
        if Iter >= min_verify_Iters and Iter % verify_Iters_step == 0:
            ...
            test_result = test_on_model(model=d_model, test_list=H5_List_test, iters=Iter, save_path=Result_save_Path, data_input_shape=data_input_shape,front_name = 'test')
