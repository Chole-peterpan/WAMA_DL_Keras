...
aug_num = 20000;%自己设定每类样本扩增的总数量，最终扩增数量会接近此数量
...
per_sub_augnum_A = floor(aug_num/sub_num_A);%非PD 每个样本扩增的大概数量
per_sub_augnum_B = floor(aug_num/sub_num_B);%PD 每个样本扩增的大概数量
