...
savepath = 'H:\@data_dasheng_fufa_dl\分折信息';
%% AUG data 4 train and verify
% AUG ：all negative object fold in a cell
AUG_fold_cell{1}='H:\@data_dasheng_fufa_dl\@aug_data';
...
test_fold_cell{1}='H:\@data_dasheng_fufa_dl\@test_data';
...
n_fold_cell{1}='G:\$code_dasheng\final_data\@new_data\1mat\fufa';
% n_fold_cell{2}='';
% n_fold_cell{3}='';
% n_fold_cell{4}='';

% cut ：all positive object fold in a cell
p_fold_cell{1}='G:\$code_dasheng\final_data\@new_data\1mat\bufufa';
% p_fold_cell{2}='';
% p_fold_cell{3}='';
% p_fold_cell{4}='';
