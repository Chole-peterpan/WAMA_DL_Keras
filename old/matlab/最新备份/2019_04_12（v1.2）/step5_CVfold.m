...
AUG_fold_cell{1}='H:\@data_liaoxiao\3aug_10000';
...
test_fold_cell{1}='H:\@data_liaoxiao\4test';
...
n_fold_cell{1}='H:\@data_liaoxiao\1mat\nanPD';
% n_fold_cell{2}='';
% n_fold_cell{3}='';
% n_fold_cell{4}='';

% cut ：all positive object fold in a cell
p_fold_cell{1}='H:\@data_liaoxiao\1mat\PD';
% p_fold_cell{2}='';
% p_fold_cell{3}='';
% p_fold_cell{4}='';
