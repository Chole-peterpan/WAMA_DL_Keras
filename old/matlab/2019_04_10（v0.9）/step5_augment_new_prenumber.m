clc;
clear;
mat_path = 'G:\@data_zhuanyi_zhongshan\PNENs_wang_dl\@data\v\4block\zhuanyi';
mat_savepath = 'H:\@data_pnens_zhuanyi_dl\v';
filename_list = dir(strcat(mat_path,filesep,'*.mat'));

subject_path = 'G:\@data_zhuanyi_zhongshan\PNENs_wang_dl\@data\v\1mat\zhuanyi';%仅仅需要对应类别样本数量，1mat即可，不要block文件夹
