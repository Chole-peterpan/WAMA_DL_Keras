...
clear;
%设置参数
save_path = 'G:\@data_NENs_response\data_2D\1mat';
nii_path = 'G:\@data_NENs_response\data\0nii';
%=====================================================================
%提取病例信息
...
for i = 1:length(subject)
    ...
    for ii = 1:length(subject(i).v_id)
        ...
        for iii = 1:length(tmp_mat)
            ...
            [tumor_mat,mask_mat,tumor_size,or_size] = get_region_from_mask(Data_CT,Data_mask,5);%参数：前者CT，后者mask
            ...
            subject_temp.or_size{end+1} = or_size;
        end
    ...
    subject(i).or_size = subject_temp.or_size;
