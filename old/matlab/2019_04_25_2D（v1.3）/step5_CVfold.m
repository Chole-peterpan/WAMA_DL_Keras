...
savepath = 'G:\@data_NENs_response\data_2D\CVfolder5';
%% AUG data 4 train and verify（h5文件）
% AUG ：all negative object fold in a cell
AUG_fold_cell{1}='G:\@data_NENs_response\data_2D\3aug_20000';
...
test_fold_cell{1}='G:\@data_NENs_response\data_2D\4test';
...
n_fold_cell{1}='G:\@data_NENs_response\data_2D\1mat\a';
% n_fold_cell{2}='';
% n_fold_cell{3}='';
% n_fold_cell{4}='';

% cut ：all positive object fold in a cell
p_fold_cell{1}='G:\@data_NENs_response\data_2D\1mat\b';
% p_fold_cell{2}='';
% p_fold_cell{3}='';
% p_fold_cell{4}='';
