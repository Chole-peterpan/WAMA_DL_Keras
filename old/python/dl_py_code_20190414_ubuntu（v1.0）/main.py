...
for item in contents:
    content = item.strip()
    final_content = test_path + file_sep + content
...
for item in contents:
    content = item.strip()
    final_content = aug_path + file_sep + content
...
if __name__ == "__main__":
    ...
    # txt as a log
    loss_txt = Result_save_Path + file_sep+'@' + foldname + '_loss.txt'
    verify_result_txt = Result_save_Path + file_sep+'@' + foldname + '_ver_result.txt'
    test_result_txt = Result_save_Path + file_sep+'@' + foldname + '_test_result.txt'

    verify_acc_txt = Result_save_Path + file_sep+'@' + foldname + '_ver_acc.txt'
    verify_AUC_txt = Result_save_Path + file_sep+'@' + foldname + '_ver_AUC.txt'
    test_acc_txt = Result_save_Path + file_sep+'@' + foldname + '_test_acc.txt'
    test_AUC_txt = Result_save_Path + file_sep+'@' + foldname + '_test_AUC.txt'
