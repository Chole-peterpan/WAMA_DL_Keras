...
from w_resnet import resnet, resnet_nobn, se_resnet, resnet1
...
Result_save_Path = r'/data/XS_Aug_model_result/model_templete/diploma_real/test24'#============================#!!!!!! 保存路径保存路径保存路径保存路径保存路径
