...
def identity_block1(x, nb_filters, name, kernel_size=3, use_bias_flag=True):
    k1, k2, k3 = nb_filters
    convname1 = name + 'conv1'
    convname2 = name + 'conv2'
    convname3 = name + 'conv3'
...
def conv_block1(x, nb_filters, name, kernel_size=3, use_bias_flag=True):
    k1, k2, k3 = nb_filters
    convname1 = name + 'conv1'
    convname2 = name + 'conv2'
    convname3 = name + 'conv3'
...
def resnet1(classes=2, use_bias_flag=True):
    '''
    :param use_bias_flag: 是否使用偏置，包括卷积层与全连接层
    :param bn_flag: 是否使用bn层，全网络范围
    :param classes:类的数量
    ...
    out = conv_block1(out, [64, 64, 256], name='L1_block1', use_bias_flag=use_bias_flag)
    print("conv1 shape:", out.shape)
    out = identity_block1(out, [64, 64, 256], name='L1_block2', use_bias_flag=use_bias_flag)
    out = identity_block1(out, [64, 64, 256], name='L1_block3', use_bias_flag=use_bias_flag)

    out = conv_block(out, [128, 128, 512], name='L2_block1', use_bias_flag=use_bias_flag)
    print("conv2 shape:", out.shape)
    out = identity_block1(out, [128, 128, 512], name='L2_block2', use_bias_flag=use_bias_flag)
    out = identity_block1(out, [128, 128, 512], name='L2_block3', use_bias_flag=use_bias_flag)
    out = identity_block1(out, [128, 128, 512], name='L2_block4', use_bias_flag=use_bias_flag)


    out = conv_block1(out, [256, 256, 1024], name = 'L3_block1', use_bias_flag=use_bias_flag)
    print("conv3 shape:", out.shape)
    out = identity_block1(out, [256, 256, 1024], name='L3_block2', use_bias_flag=use_bias_flag)
    out = identity_block1(out, [256, 256, 1024], name='L3_block3', use_bias_flag=use_bias_flag)
    out = identity_block1(out, [256, 256, 1024], name='L3_block4', use_bias_flag=use_bias_flag)
    out = identity_block1(out, [256, 256, 1024], name='L3_block5', use_bias_flag=use_bias_flag)
    out = identity_block1(out, [256, 256, 1024], name='L3_block6', use_bias_flag=use_bias_flag)

    out = conv_block1(out, [512, 512, 2048], name='L4_block1', use_bias_flag=use_bias_flag)
    print("conv4 shape:", out.shape)
    out = identity_block1(out, [512, 512, 2048], name='L4_block2', use_bias_flag=use_bias_flag)
    out = identity_block1(out, [512, 512, 2048], name='L4_block3', use_bias_flag=use_bias_flag)
