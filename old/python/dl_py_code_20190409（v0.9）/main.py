...
from function import sigmoid_y, pause, verify_on_model, test_on_model, test_on_model4_subject
from net import resnetttt, alexnet_jn  # use as :Resnetttt(tuple(data_input_shape+[1]))
from Net_new import ClassNet,se_ClassNet
from dense_net import se_create_dense_net,create_dense_net
...
batch_size = 2
max_iter = 200000
min_verify_Iters = 2000   # 开始验证的最小迭代次数
...
Result_save_Path = r'/data/XS_Aug_model_result/model_templete/diploma/pnens_zhuanyi_densenet/fold2'#============================
...
batch_name = 'pnens_zhuanyi_Densenet_net'
#======================================================================================================================
