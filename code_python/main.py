...
aug_path = r'/data/@data_pnens_recurrent_new/data_aug/v'  # CD patient is positive
test_path = r'/data/@data_pnens_recurrent_new/data_test/v'
folder_path = r'/data/@data_pnens_recurrent_new/CVfold5_newnew'# 分折信息文件路径
...
if __name__ == "__main__":
    ...
    #     filepath='/data/XS_Aug_model_result/model_templete/recurrent/pnens_zhuanyi_resnet_v_new(fuxk)/fold4/m_35000_model.h5',
    #     by_name=True)
    #===================================================================================
