...
def resnet3D(classes=2, use_bias_flag=True,inputshape=[180,180,180]):
    '''
    ...
    inputs = Input(shape=inputshape, name='input1')
    # 256*256*128
    ...
    out = MaxPooling3D((3, 3, 3), strides=(2, 2, 2), padding='same')(out)
